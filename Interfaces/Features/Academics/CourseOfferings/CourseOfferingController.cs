...
{
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponse<PaginationResponse<CourseOfferingResponseModel>>), StatusCodes.Status200OK)]
    ...
    public async Task<ActionResult> Create(ApiRequest<CreateCourseOfferingRequestModel> request)
    {
    ...
    [HttpGet("{id}")]
    [ProducesResponseType(typeof(ApiResponse<CourseOfferingResponseModel>), StatusCodes.Status200OK)]
    ...
    [HttpPut("{id}")]
    [ProducesResponseType(typeof(ApiResponse<NoResponseModel>), StatusCodes.Status200OK)]
    public async Task<ActionResult> Update(string id, ApiRequest<UpdateCourseOfferingRequestModel> request)
    {
