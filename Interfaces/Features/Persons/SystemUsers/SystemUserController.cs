...
{
    [HttpGet]
    [ProducesResponseType(typeof(ApiResponse<PaginationResponse<SystemUserResponseModel>>), StatusCodes.Status200OK)]
    ...
    public async Task<ActionResult> Create(ApiRequest<CreateSystemUserRequestModel> request)
    {
    ...
    [HttpGet("{id}")]
    [ProducesResponseType(typeof(ApiResponse<SystemUserResponseModel>), StatusCodes.Status200OK)]
    ...
    [HttpPut("{id}")]
    [ProducesResponseType(typeof(ApiResponse<NoResponseModel>), StatusCodes.Status200OK)]
    public async Task<ActionResult> Update(string id, ApiRequest<UpdateSystemUserRequestModel> request)
    {
